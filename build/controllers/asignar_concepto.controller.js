...
var AsignarConcepto = require('../models/Asignar_Concepto');
...
var getAsignarConceptos = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return AsignarConcepto.findAll();
        case 3:
          asignarConceptos = _context.sent;
  ...
  return function getAsignarConceptos(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Obtener un registro por ID
var getAsignarConceptoById = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var idAsignar_Concepto, asignarConcepto;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          asignarConcepto = _context2.sent;
          if (asignarConcepto) {
            _context2.next = 7;
            break;
          }
  ...
  return function getAsignarConceptoById(_x3, _x4) {
...
var updateAsignarConcepto = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return AsignarConcepto.findByPk(idAsignar_Concepto);
        case 5:
          asignarConcepto = _context4.sent;
          if (asignarConcepto) {
            _context4.next = 8;
            break;
          }
  ...
  return function updateAsignarConcepto(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();

// Eliminar un registro
var deleteAsignarConcepto = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return AsignarConcepto.findByPk(idAsignar_Concepto);
        case 4:
          asignarConcepto = _context5.sent;
          if (asignarConcepto) {
            _context5.next = 7;
            break;
          }
        ...
        case 7:
          _context5.next = 9;
          return asignarConcepto.destroy();
        case 9:
          res.status(200).json({
  ...
  return function deleteAsignarConcepto(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
module.exports = {
  getAsignarConceptos: getAsignarConceptos,
  getAsignarConceptoById: getAsignarConceptoById,
  createAsignarConcepto: createAsignarConcepto,
  updateAsignarConcepto: updateAsignarConcepto,
  deleteAsignarConcepto: deleteAsignarConcepto
};