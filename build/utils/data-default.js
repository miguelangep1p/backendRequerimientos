...
var _require = require('../models/role.model.js'),
  Role = _require.Role;
var _require2 = require('../models/user.model.js'),
  User = _require2.User;
var bcrypt = require("bcryptjs");
function createDefaultData() {
  return _createDefaultData.apply(this, arguments);
}
function _createDefaultData() {
  _createDefaultData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 23:
          ...
          console.error('Error al crear datos por defecto:', _context.t0);
        case 26:
        case "end":
