...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Ajusta la ruta según tu estructura de directorios
...
var register = exports.register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _registerSchema$valid, error, _req$body, email, username, password, emailExist, usernameExist, salt, hashedPassword, user, savedUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", (0, _responseTypes.badRequest)(res, error.details[0].message));
        case 3:
          _req$body = req.body, email = _req$body.email, username = _req$body.username, password = _req$body.password; // Verificar si el usuario ya existe
          _context.next = 6;
        ...
        case 6:
          ...
          return _context.abrupt("return", (0, _responseTypes.badRequest)(res, "El correo ya está registrado"));
        case 9:
          _context.next = 11;
          return _userModel.User.findOne({
            where: {
        ...
        case 11:
          ...
          return _context.abrupt("return", (0, _responseTypes.badRequest)(res, "El nombre de usuario ya está registrado"));
        case 14:
          _context.next = 16;
        ...
        case 24:
          ...
          (0, _responseTypes.success)(res, _objectSpread({}, savedUser.dataValues));
          _context.next = 31;
          break;
        case 28:
          _context.prev = 28;
...
exports.login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _loginSchema$validate, error, _req$body2, email, password, user, validPass, userWithoutPassword, role, token;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", (0, _responseTypes.badRequest)(res, error.details[0].message));
        case 3:
          _req$body2 = req.body, email = _req$body2.email, password = _req$body2.password; // Verificar si el email existe
          _context2.next = 6;
          return _userModel.User.findOne({
        ...
        case 6:
          ...
          return _context2.abrupt("return", (0, _responseTypes.badRequest)(res, "Aún no estas registrado"));
        case 9:
          _context2.next = 11;
        ...
        case 11:
          ...
          return _context2.abrupt("return", (0, _responseTypes.badRequest)(res, "Credenciales inválidas"));
        case 14:
          ...
          _context2.next = 18;
          return _roleModel.Role.findOne({
            where: {
              roleId: user.roleId
            }
          });
